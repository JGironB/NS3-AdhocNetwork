...
int main (int argc, char *argv[])
{
  ...
  mobilityWayPoint.Set("X", StringValue("ns3::UniformRandomVariable[Min=0|Max=500]"));
  mobilityWayPoint.Set("Y", StringValue("ns3::UniformRandomVariable[Min=0|Max=500]"));
  ...
  mobility.SetMobilityModel ("ns3::RandomWaypointMobilityModel",
                                   "Speed", StringValue("ns3::UniformRandomVariable[Min=1.3|Max=1.8]"),
                                   "Pause", StringValue("ns3::UniformRandomVariable[Min=1.3|Max=1.8]"),
